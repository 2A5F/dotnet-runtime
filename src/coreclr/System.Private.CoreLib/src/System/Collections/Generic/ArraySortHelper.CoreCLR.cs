...
namespace System.Collections.Generic
{
        ...
        where TComparer : IComparer<T>?
    {
        ...
        private static IArraySortHelperSpecialization<T, TComparer> CreateArraySortHelper()
        {
            ...
            if (typeof(IComparable<T>).IsAssignableFrom(typeof(T)))
            {
                defaultArraySortHelper = (IArraySortHelperSpecialization<T, TComparer>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(GenericArraySortHelperSpecialization<string, IComparer<string>>), (RuntimeType)typeof(T), (RuntimeType)typeof(TComparer));
            }
            else
            {
