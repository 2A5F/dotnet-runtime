...
namespace System.Collections.Generic
{
        ...
        : AArraySortHelper<T>
    {
        ...
        private static AArraySortHelper<T> CreateArraySortHelper()
        {
            ...
            {
                defaultArraySortHelper = (AArraySortHelper<T>)RuntimeType.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(GenericArraySortHelper<>), (RuntimeType)typeof(T));
            }
            else
            {
        ...
        : AArraySortHelperPaired<TKey, TValue>
    {
        ...
        private static AArraySortHelperPaired<TKey, TValue> CreateArraySortHelper()
        {
            ...
            {
                defaultArraySortHelper = (AArraySortHelperPaired<TKey, TValue>)RuntimeType.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(GenericArraySortHelperPaired<,>), (RuntimeType)typeof(TKey), (RuntimeType)typeof(TValue));
            }
            else
            {
